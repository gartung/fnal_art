...
class Lardata(CMakePackage):
    ...
    version('09.04.vecmt02.01', branch='larvecutils-v09_04_02_01', git='https://github.com/cerati/lardata.git')
    ...
    patch('v09_04_02_vecmt01.patch', when='@09.04.vecmt02.01')
    ...
    depends_on('larvecutils', when='@09.04.vecmt02.01')
    depends_on('range-v3')
    depends_on('fftw')
