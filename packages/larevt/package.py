...
class Larevt(CMakePackage):
    ...
    version('09.03.05vecmt.01', tag='mtsp-v09_37_02_04', git='https://github.com/cerati/larevt.git', get_full_repo=True )
    ...
    patch('v09_03_05_vecmt01.patch', when='@09.03.05vecmt.01')
